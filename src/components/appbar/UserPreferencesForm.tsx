...
/**
 * This component is for simplicity of UserPreferencesModal.
 *
...
export const UserPreferencesForm = ({ onClose }: UserPreferencesFormProps) => {
  ...
  return (
    <form onSubmit={form.handleSubmit(formSubmitHandler)}>
      ...
      <div className="flex flex-1 flex-col justify-between gap-2 py-4 sm:flex-row">
